...
import { handleAddShips, handleAddUser, handleAttack, handleCreateRoom, handleRandomAttack } from "../modules/gameRequest/gameRequest.ts";
...
export const commandsMapper = {
    ...
    [Commands.ADD_USER]: handleAddUser,
